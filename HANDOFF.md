...
- **App:** `v0.34`, live at **https://kevinbigham.github.io/kevinos/** (GitHub Pages, public repo `KevinBigham/kevinos`).
...
│   ├── index.html                   ← THE APP (v0.34, ES5)
│   ├── manifest.json                ← PWA manifest (+ share_target)
│   ├── sw.js                        ← service worker (CACHE = "kevinos-v0_34", + push / notificationclick)
...
- **Next mission feature:** #9 Goals & Weekly Check-In, then #10 Morning Launch Sequence.
