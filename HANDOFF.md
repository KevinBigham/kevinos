...
- **App:** `v0.18`, live at **https://kevinbigham.github.io/kevinos/** (GitHub Pages, public repo `KevinBigham/kevinos`).
...
│   ├── index.html                   ← THE APP (v0.18, ~2500 lines, ES5)
│   ├── manifest.json                ← PWA manifest (+ share_target)
│   ├── sw.js                        ← service worker (CACHE = "kevinos-v0_18", + push / notificationclick)
...
- **Beyond:** overnight AI drafting (cron), unified multi-account inbox triage, Outlook — all natural extensions, none started. Do NOT start unprompted.
