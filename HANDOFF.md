...
*Written 2026-06-22; covers through v0.37 (2026-07-01). Read this first. It's the complete state of the project so you can pick up cold. Everything (app + backend + docs) lives in one repo: `github.com/KevinBigham/kevinos`.*
...
- **App:** `v0.37`, live at **https://kevinbigham.github.io/kevinos/** (GitHub Pages, public repo `KevinBigham/kevinos`).
...
│   ├── index.html                   ← THE APP (v0.37, ES5)
│   ├── manifest.json                ← PWA manifest (+ share_target)
│   ├── sw.js                        ← service worker (CACHE = "kevinos-v0_37", + push / notificationclick)
