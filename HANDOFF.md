...
- **App:** `v0.27`, live at **https://kevinbigham.github.io/kevinos/** (GitHub Pages, public repo `KevinBigham/kevinos`).
...
- **Beyond (none started — do NOT start unprompted):** unified multi-account inbox triage (one merged stream across accounts); a weekly review digest; snooze/triage actions; Outlook.
