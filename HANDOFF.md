...
- **Beyond (none started — do NOT start unprompted):** overnight AI email drafting (cron pre-drafts replies to real emails so mornings show ready drafts); unified multi-account inbox triage; smart "needs you vs noise" inbox sorting; Outlook.
