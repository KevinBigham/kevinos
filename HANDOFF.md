...
- **App:** `v0.20`, live at **https://kevinbigham.github.io/kevinos/** (GitHub Pages, public repo `KevinBigham/kevinos`).
...
- **Beyond (none started — do NOT start unprompted):** overnight AI email drafting (cron); unified multi-account inbox triage; Outlook; a relay-side brief (cron pulls the synced D1 doc so the 8am AI brief is generated fresh server-side rather than at last app sync).
