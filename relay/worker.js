...
function fabricResponseFormat(prompt) {
  ...
  for (const field of required) {
    ...
    else if (field === "redactions") properties[field] = { type: "array", items: { type: "string" } };
    else if (field === "number") properties[field] = { type: "number" };
    else properties[field] = { type: "string" };
  }
  return { type: "json_schema", json_schema: { name: "kevinos_proposal", strict: true, schema: { type: "object", properties, required, additionalProperties: false } } };
}
