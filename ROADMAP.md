...
**On deck:** continue the remaining **9 features in [`MISSION.md`](MISSION.md)** (build order now #2 → #3 → #5 → #4 → #6 → #7 → #8 → #9 → #10), plus the older backlog — a **unified weekly-review across all life areas** (not just email), **batch triage** (archive/snooze a whole group at once), **send-later / scheduled replies**, and **Outlook**.
