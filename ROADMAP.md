...
**On deck (only on Kevin's go):** overnight email drafting (cron pre-drafts replies to real emails so mornings show ready drafts), unified multi-account inbox triage, smart "needs you vs noise" inbox sorting, and Outlook.
