...
const EXPORT_NAMES = [
  ...
  "normalizeRoleRecord", "normalizeTaskRecord", "normalizeProjectAiPolicy", "normalizeProjectRecord", "normalizeBuildRecord", "normalizeEventRecord", "normalizePersonRecord", "normalizeGoalRecord", "normalizeDecisionRecord", "normalizeBriefRecord", "normalizeLinkedRecord", "normalizeLabBudget", "normalizePortfolio", "normalizeStateV40", "migrateV39ToV40", "validateStateV40", "legacyRoleId", "roleIdForLegacyArea", "strongerPrivacy", "protectArrayPrivacy", "seedV40Playbooks",
  "relationshipIndex", "relationshipDiagnostics", "dueDecisionRevisits", "communicationCommitments", "typedSearchRecords", "typedPaletteEntries", "adminMoneyRadar", "evidenceTimeline", "normalizeLabSignals", "loadLabSignals", "recordLabSignal", "knowledgeConversionPlan", "parseDecisionOptions", "projectResumeCapsule", "fabricPrivacyForRecord", "contextRecordFields", "buildProjectAiContextCapsule", "projectContextPacket", "projectHubHTML", "ensureStudioIncubatorProject", "addBuild",
